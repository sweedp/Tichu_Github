...
class CardSuit(ComparableEnum):
    ...
    # supposed to be with 4 standard colors
    # TODO Fix unicode
    #SWORD = u"\u2665"  # 'CROSSED SWORDS' (U+2694) # hearts
    #JADE = u"\u2666"  # 'Diamond ' U+2666
    #PAGODA = u'\u2663' #  # clubs
    ...
    SWORD = " black"  # 'CROSSED SWORDS' (U+2694) # hearts
    JADE = " green"  # 'Diamond ' U+2666
    PAGODA = ' blue' #  # clubs
    STAR = " red"  # 'BLACK STAR' (U+2605)
    SPECIAL = ' white'
